...
;
async function GET() {
    const items = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$aps$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["listObjects"])();
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(items.map((o)=>({
            name: o.objectKey,
            urn: (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$aps$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["urnify"])(o.objectId)
        })));
}
async function POST(request) {
    const form = await request.formData();
    const file = form.get('model-file');
    const entry = form.get('model-zip-entrypoint') || undefined;
    if (!file) {
    ...
    await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].writeFile(tmpPath, buffer);
    const obj = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$aps$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["uploadObject"])(file.name, tmpPath);
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$aps$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["translateObject"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$aps$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["urnify"])(obj.objectId), entry);
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        name: obj.objectKey,
        urn: (0, __TURBOPACK__imported__module__$5b$project$5d2f$services$2f$aps$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["urnify"])(obj.objectId)
    });
}
}}),
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f68c7f8e._.js.map