...
function HomePage() {
            ...
            script.onload = ({
                "HomePage.useEffect": ()=>{
                    ...
                    const getAccessToken = {
                        "HomePage.useEffect.getAccessToken": (cb)=>{
                            fetch('/api/auth/token').then({
                                "HomePage.useEffect.getAccessToken": (r)=>r.json()
                            }["HomePage.useEffect.getAccessToken"]).then({
                                "HomePage.useEffect.getAccessToken": (d)=>cb(d.access_token, d.expires_in)
                            }["HomePage.useEffect.getAccessToken"]).catch(console.error);
                        }
                    }["HomePage.useEffect.getAccessToken"];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HomePage.useEffect": ()=>{
            ...
            }["HomePage.useEffect"]).then(setModels).catch(console.error);
        }
    }["HomePage.useEffect"], []);
    // Handle uploads
                ...
                "HomePage.useEffect.check": async ()=>{
                    ...
                    if (st.status === 'inprogress') {
                        ...
                        window.Autodesk.Viewing.Document.load('urn:' + selected, {
                            ...
                            "HomePage.useEffect.check": (_code, msg)=>console.error(msg)
                        }["HomePage.useEffect.check"]);
                    }
                }
            }["HomePage.useEffect.check"];
...
_s(HomePage, "8k7kceM1i5/59R2ISoN59KSnvlc=");
_c = HomePage;
var _c;
