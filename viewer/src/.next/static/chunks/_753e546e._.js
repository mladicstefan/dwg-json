...
;
;
const Header = ({ busy, models, selected, onSelect, onUpload })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ModelSelector$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                busy: busy,
                models: models,
                selected: selected,
                onSelect: onSelect
...
"[project]/components/Viewer.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
        ...
        "Viewer.useEffect": ()=>{
            ...
            s.onload = ({
                "Viewer.useEffect": ()=>{
                    ...
                    async function init() {
                        const getToken = {
                            "Viewer.useEffect.init.getToken": (cb)=>{
                                fetch('/api/auth/token').then({
                                    "Viewer.useEffect.init.getToken": (r)=>r.json()
                                }["Viewer.useEffect.init.getToken"]).then({
                                    "Viewer.useEffect.init.getToken": (d)=>cb(d.access_token, d.expires_in)
                                }["Viewer.useEffect.init.getToken"]);
                            }
                        }["Viewer.useEffect.init.getToken"];
...
_s(Viewer, "8uVE59eA/r6b92xF80p7sH8rXLk=");
_c = Viewer;
...
"[project]/components/StatusOverlay.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var _c;
__turbopack_context__.k.register(_c, "StatusOverlay");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/next/dist/compiled/react/index.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$Viewer$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/Viewer.tsx [app-client] (ecmascript)");
...
function HomePage() {
    ...
    const viewer = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    // fetch models
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HomePage.useEffect": ()=>{
            fetch('/api/models').then({
                "HomePage.useEffect": (r)=>r.json()
            }["HomePage.useEffect"]).then(setModels);
        }
    }["HomePage.useEffect"], []);
    // upload handler
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HomePage.useEffect": ()=>{
                ...
                "HomePage.useEffect.check": async ()=>{
                    ...
                    if (st.status === 'inprogress') {
                        ...
                        window.Autodesk.Viewing.Document.load('urn:' + selected, {
                            "HomePage.useEffect.check": (doc)=>viewer.current.loadDocumentNode(doc, doc.getRoot().getDefaultGeometry())
                        }["HomePage.useEffect.check"], {
                            "HomePage.useEffect.check": (_c, m)=>console.error(m)
                        }["HomePage.useEffect.check"]);
                    }
                }
            }["HomePage.useEffect.check"];
            check();
            return ({
                "HomePage.useEffect": ()=>clearTimeout(id)
            })["HomePage.useEffect"];
        }
    }["HomePage.useEffect"], [
        selected
...
_s(HomePage, "HqzEg67gWXIvqLEdFvc2ktgS+vE=");
_c = HomePage;
var _c;
...
//# sourceMappingURL=_753e546e._.js.map